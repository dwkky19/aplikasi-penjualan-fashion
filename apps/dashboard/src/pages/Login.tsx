...
export default function Login() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    e.preventDefault();
    if (
      (username === "admin super" && password === "adminsuper") ||
      ...
      setError("Nama pengguna atau kata sandi tidak valid. Akses ditolak.");
  ...
  return (
    <div className="bg-surface-container-lowest text-on-surface font-body min-h-screen flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img className="w-full h-full object-cover opacity-20 grayscale brightness-50" alt="Blurred high-fashion editorial photo in deep shadows with sharp purple and cyan neon light leaks and silk textures" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBMA8ZCf1LhC81GsDjTspzHfwXcC4ncGo8HXt9EqlPLSyJr4NArxsTCVvqP7z3njXC_YI-7GDnCjgWUF1Zf8e3qIYt3fAQMRVOnGsAC3otPW-wCbsMpwWQdxPEs4VtJZwkKJA3r9VGJU7FAWXNxXmPMu4aMuGWNo2U2gcpRuo0AxEFAP38ATlqmw2S-m6W-GrLG4WwJhrHQUcUCsyGNZpKBVX5kUGAaav7dlNQsWEnmOyuCxQ-N2EGC7eJx-kNKRKI61Oo4Fd-PCWs" />
        <div className="absolute inset-0 bg-login-gradient opacity-90"></div>
        {/* Synthetic Light Orbs */}
        ...
        <div className="glass-panel border-t border-l border-white/5 rounded-xl p-10 neon-accent-glow">
          ...
          <form className="space-y-6" onSubmit={handleLogin}>
            ...
            <div className="space-y-1.5">
              <label className="text-[0.6875rem] uppercase font-semibold tracking-widest text-outline ml-1">Nama Pengguna</label>
            ...
            {/* Primary Action */}
            <button className="w-full primary-gradient-btn text-white font-bold py-4 mt-4 rounded-lg shadow-[0_0_20px_rgba(124,58,237,0.3)] hover:shadow-[0_0_30px_rgba(124,58,237,0.5)] hover:scale-[1.01] active:scale-[0.98] transition-all duration-300 tracking-tight" type="submit">
              Masuk
            </button>
          </form>
        </div>
      ...
      {/* Side Decorative Detail (Asymmetry) */}
